...
namespace SalariesDll
{
    ...
    public class Salarie
    {
        ...
        //Constructeur(entier)
        public Salarie(String matricule, string nom, string prenom, DateTime dateNaissance, double salaireBrut, 
            double txCs):this(matricule, nom, prenom)
        {
        ...
        public Salarie(string matricule, string nom, string prenom, string v1, string v2, string v3, string v4) : this(matricule, nom, prenom)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.v3 = v3;
        ...
        public Salarie(string matricule, string nom, string prenom, string v1, string v2, string v3) : this(matricule, nom, prenom)
        {
            this.v1 = v1;
            this.v2 = v2;
            this.v3 = v3;
        ...
        {
            return string.Format("{0};{1};{2};{3};{4};{5};{6}",this.Matricule,this.Nom,
